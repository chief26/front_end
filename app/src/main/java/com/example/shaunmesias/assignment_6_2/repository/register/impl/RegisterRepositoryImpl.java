...
public class RegisterRepositoryImpl extends SQLiteOpenHelper implements RegisterRepository {
    ...
    public Register findById(long id) {
        ...
        Cursor cursor = db.query(TABLE_NAME, new String[]{COLUMN_ID, COLUMN_NAME, COLUMN_PASSWORD, COLUMN_EMAIL}
                , COLUMN_ID + " =?"
    ...
    {
        String[] columns = {COLUMN_ID,COLUMN_NAME, COLUMN_NAME, COLUMN_PASSWORD, COLUMN_EMAIL};
        open();
