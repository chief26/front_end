...
public class LoginActivity extends AppCompatActivity {
    ...
    public void ButtonLogin(View v){
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            if (cursor.moveToNext()) {
                ...
                if(c_name.compareTo(name.getText().toString()) == 0 && c_password.compareTo(password.getText().toString()) == 0)
                {
    ...
    public void ButtonRegister(View v){
        ...
        Register reg = RegisterFactory.getRegister(name.getText().toString(), password.getText().toString(), "a@v.com");
